void menuTaskCallback() {
  ...
  if (millis() - displayTimer >= 500) {
    ...
    menu.formatMenu(mainMenu, menu.get(0), "Air   :%3dNTU", (int)var.turbidity);
    ...
    // menu.formatMenu(mainMenu, menu.get(4), "pHUp  : %5.2f", var.waterLevel1);
    // menu.formatMenu(mainMenu, menu.get(5), "pHDown: %5.2f", var.waterLevel2);
    // menu.formatMenu(mainMenu, menu.get(6), "Garam : %5.2f", var.waterLevel3);
    displayTimer = millis();
  }
